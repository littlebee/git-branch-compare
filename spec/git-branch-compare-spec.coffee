GitBranchCompare = require '../lib/git-branch-compare'
  ...
  describe "when the git-branch-compare:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        gitBranchCompareElement = workspaceElement.querySelector('.git-branch-compare')
        expect(gitBranchCompareElement).toExist()

        gitBranchComparePanel = atom.workspace.panelForItem(gitBranchCompareElement)
